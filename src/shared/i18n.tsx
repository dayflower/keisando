...
const enMessages = {
  ...
  "history.currentCorrectStreak": "Current correct streak",
  "history.bestCorrectStreak": "Best correct streak",
  ...
  "debug.unlockAllStages": "Unlock All Stages (Active Player)",
  "debug.resetUnlockProgress": "Reset Stage Unlock Progress (Active Player)",
  "debug.clearAllData": "Clear All Local Data",
  "debug.stageSettings": "Stage Settings",
  "debug.questionCount": "Question count",
  "debug.clearWithinSeconds": "Clear within (seconds)",
  "debug.maxMistakesAllowed": "Max mistakes allowed (-1 = unlimited)",
  "debug.resetStageSettings": "Reset Stage Settings to Default",
...
const jaMessages: Record<MessageKey, string> = {
  ...
  "history.currentCorrectStreak": "現在の連続正解数",
  "history.bestCorrectStreak": "最高連続正解数",
  ...
  "debug.storage": "ストレージ",
  "debug.unlockAllStages": "全ステージを解放 (現プレイヤー)",
  "debug.resetUnlockProgress": "ステージ解放状況をリセット (現プレイヤー)",
  "debug.clearAllData": "ローカルデータをすべて削除",
  "debug.stageSettings": "ステージ設定",
  "debug.questionCount": "問題数",
  "debug.clearWithinSeconds": "クリア制限時間 (秒)",
  "debug.maxMistakesAllowed": "ミス許容回数 (-1 で無制限)",
  "debug.resetStageSettings": "ステージ設定を初期値に戻す",
  "debug.effects": "演出",
